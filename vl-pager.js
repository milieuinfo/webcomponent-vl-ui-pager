           ...
           <div class="vl-pager">
            <ul class="vl-pager__list">
              ...
              <li class="vl-pager__element">
                ...
                </li>`}}get totalPages(){return this.totalItems/this.itemsPerPage+(this.totalItems%this.itemsPerPage>0?1:0)}get totalItems(){return parseInt(this.getAttribute("total-items"))}get currentPage(){return parseInt(this.getAttribute("current-page"))}get itemsPerPage(){return parseInt(this.getAttribute("items-per-page"))}get firstItemNrOfPage(){return(this.currentPage-1)*this.itemsPerPage+1}get lastItemNrOfPage(){let lastItemNr=this.firstItemNrOfPage+this.itemsPerPage-1;return lastItemNr>this.totalItems?this.totalItems:lastItemNr}get lastPage(){return this.totalItems/this.itemsPerPage+(this.totalItems%this.itemsPerPage>1?1:0)}_calculatePagination(c,m){var current=c,last=m,delta=1,left=current-delta,right=current+delta+1,range=[],rangeWithDots=[],l;for(let i=1;i<=last;i++){if(i==1||i==last||i>=left&&i<right){range.push(i)}}for(let i of range){if(l){if(i-l===2){rangeWithDots.push(l+1)}else if(i-l!==1){rangeWithDots.push("cta")}}rangeWithDots.push(i);l=i}return rangeWithDots}};define("vl-pager",VlPager);